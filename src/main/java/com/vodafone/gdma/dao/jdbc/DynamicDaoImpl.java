package com.vodafone.gdma.dao.jdbc;
...
import com.vodafone.gdma.audit.Auditable;
...
import com.vodafone.gdma.util.DataSourcePool;
import com.vodafone.gdma.util.Formatter;
import com.vodafone.gdma.util.PagedResultSetExtractor;
import com.vodafone.gdma.util.RowMapper;
...
public class DynamicDaoImpl implements DynamicDao {
     ...
     * (non-Javadoc)
     * 
     * @seecom.vodafone.gdma.dao.DynamicDao#get(com.vodafone.gdma.web.command.
     * PaginatedRequest)
     */
     ...
     * 
     * @see
     * com.vodafone.gdma.dao.DynamicDao#getCount(com.vodafone.gdma.domain.Server
     * , com.vodafone.gdma.domain.Table, java.util.List)
     */
     ...
     * 
     * @see
     * com.vodafone.gdma.dao.DynamicDao#addRecord(com.vodafone.gdma.web.command
     * .UpdateRequest)
     */
    @Auditable
     ...
     * 
     * @see
     * com.vodafone.gdma.dao.DynamicDao#updateRecords(com.vodafone.gdma.web.
     ...
     * 
     * @see
     * com.vodafone.gdma.dao.DynamicDao#deleteRecords(com.vodafone.gdma.web.
     * command.UpdateRequest)
     */
    @Auditable
     ...
     * 
     * @see
     * com.vodafone.gdma.dao.DynamicDao#getDropDownData(com.vodafone.gdma.domain
     * .Column, com.vodafone.gdma.domain.Column)
     */
