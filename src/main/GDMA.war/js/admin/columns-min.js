...
YAHOO.GDMA.admin.columns.fields={fields:[{key:"id",parser:YAHOO.util.DataSource.parseNumber},{key:"name",parser:YAHOO.util.DataSource.parseString},{key:"columnType"},{key:"columnTypeString",parser:YAHOO.util.DataSource.parseString},{key:"columnType"},{key:"primarykey"},{key:"displayed"},{key:"allowInsert"},{key:"allowUpdate"},{key:"nullable"},{key:"dropDownColumnDisplay"},{key:"dropDownColumnStore"},{key:"special"},{key:"minWidth"},{key:"maxWidth"},{key:"orderby"},{key:"columnSize"},{key:"active"}]};
