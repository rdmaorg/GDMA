...
public class UserAccessDaoImplTest extends BaseSpringImplTest {
    ...
    public void testloadAll() {
        ...
        //Users
    	assertNotNull(userAccessDao);
        List userAccesses = userAccessDao.get();
        assertTrue(userAccesses.size() > 0);
        for (Object o : userAccesses) {
        	UserAccess userAccess = (UserAccess) o;
            LOG.debug(userAccess.getAllowDisplay());
            LOG.debug(userAccess.getTable().getName());
